...
<head>
  ...
  <title>Domestic House Quotation Details</title>
...
<body>
  <div class="container">
    ...
    <h2>Laasana Gedara Construction - Domestic House Quotation Inquiry</h2>
    <!-- Client Information -->
    ...
    <!-- Additional Notes -->
    <div style="{{ empty($quote->additional_details['Additional_Comments']) ? 'display: none;' : '' }}">
