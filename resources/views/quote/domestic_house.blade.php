...
@section('title', 'Request a Domestic House Quote | Lassana Gedara – Sri Lanka')

@section('meta_description', 'Get a personalized quote for your dream home in Sri Lanka. Provide your project details to receive a detailed cost estimate from Lassana Gedara, the trusted experts in domestic construction.')

@section('meta_keywords', 'domestic house quote, building a home, construction estimate, Lassana Gedara, Sri Lanka, house design')
    ...
    <section class="about-area" style="margin-top: 120px;">
        <div class="container">
            <div class="sec-title text-center">
                ...
                <div class="title">Quotation for Domestic <br><span> House </span></div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1" style="background: url('assets/images/brand/back2-overlay.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: rgb(245 245 245 / 91%); border-radius: 30px;">
                    <form id="multiStepForm" action="{{ route('getQuote') }}" method="POST" class="contact-form form-validate">
                        ...
                        <div class="section active" id="section1">
                            <div class="row">
                                <h4 style="color: black;">Building Specifications:</h4>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <div class="form-group">
                                        <label for="selectOption11" class="quto">Living Room</label>
                                        <select class="form-control" id="selectOption11" name="Living_Room" required>
